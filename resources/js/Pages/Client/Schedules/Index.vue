...
export default {
    ...
    BasicFooter,
    ScheduleListFilter,
    ScheduleListTitle, BasicIcon, MainPageNavBar, Link},
		...
		<main class="flex-grow">
			<div class="relative mx-auto mt-[67px] max-w-screen-xl px-4 py-10 md:flex md:flex-row md:py-10">
                ...
                <ScheduleListTitle
                  ...
                  <SearchFilter :search_filter="filters?.search_filter" />
									<div>
          ...
          <div class="mx-auto max-w-2xl hs-accordion-group grid gap-3">
              ...
              <div v-if="!schedulesByFaculty || schedulesByFaculty.length === 0">
              ...
              <div v-if="schedules_paginator && !(schedules_paginator.current_page >= schedules_paginator.last_page)">
