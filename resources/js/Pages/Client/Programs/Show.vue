...
<template>
  ...
  <div v-if="form?.id !== null" class="fixed bottom-0 end-0 z-60 sm:max-w-xl w-full mx-auto p-6">
    <div class="hs-accordion-group">
  ...
  <div v-if="form?.id !== null" id="hs-vertically-centered-scrollable-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[1000000] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-vertically-centered-scrollable-modal-label">
